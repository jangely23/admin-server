    ...
    <div class="container-fluid p-3 me-3">
        ...
        <div class="col-md-12 d-flex justify-content-center">
            <div class="form-check form-switch col-md-3 mb-3 p-3 d-flex align-items-center justify-content-center" >
                <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" name="x_minuto">
                <label class="form-check-label p-3" for="flexSwitchCheckChecked"> Server X minuto</label>
            </div>

            <div class="form-check form-switch col-md-3 mb-3 p-3 d-flex align-items-center justify-content-center" >
                <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked2" name="moneda_usd">
                <label class="form-check-label p-3" for="flexSwitchCheckChecked2"> Cobro en dolares</label>
            </div>
        </div>
            ...
            <div class="col-md-12 mb-3 d-flex justify-content-center align-items-end">
