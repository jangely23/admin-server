...
<fieldset class=" shadow p-3 mb-3  rounded bg-ligth">
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <button type="button" class="btn btn-info text-white float-end" onclick="abrirPagina('forms/servidor_detalle.form.php','contenido','');"> <i class="fas fa-server"></i></button>
        </div>
    </div>
</fieldset>
