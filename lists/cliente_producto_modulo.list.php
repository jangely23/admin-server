...
<table class="table table-striped">
    ...
    <tbody>
        <?php 
            ...
            $moduloDTO->loadById($cliente_producto_moduloDTO->getId_cliente_producto(), $conexion);
        ?>
        ...
        <tr>
            ...
            <td><a class="text-warning " href="#" onclick="abrirPagina('forms/cliente_producto_modulo.form.php','contenido','&id_cliente_producto_modulo=<?php echo $cliente_producto_moduloDTO->getId_cliente_producto_modulo();?>')"><i class="fas fa-edit"></i></a></td>
            ...
            <td>
                <form action="./process/cliente_producto_modulo.process.php" id="formEliminar<?php echo $cliente_producto_moduloDTO->getId_cliente_producto_modulo();?>">
                    ...
                    <a class="text-danger " onclick="enviarFormulario(document.getElementById('formEliminar<?php echo $cliente_producto_moduloDTO->getId_cliente_producto_modulo();?>'),'',`abrirPagina('lists/cliente_producto_modulo.php', 'contenido', '');`);">
